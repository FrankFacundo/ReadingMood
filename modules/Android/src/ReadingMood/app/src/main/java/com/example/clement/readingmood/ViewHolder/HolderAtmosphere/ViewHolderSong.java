...
public class ViewHolderSong extends AbstractViewHolderAtmosphere {
    ...
    public void initializeDatas(View itemView) {
        ...
        layout_recycle= itemView.findViewById(R.id.linear_atmosphere_recycle);
        currentAtmosphereTitle = itemView.findViewById(R.id.atmosphere_title);
        currentImage = itemView.findViewById(R.id.atmosphere_image);
