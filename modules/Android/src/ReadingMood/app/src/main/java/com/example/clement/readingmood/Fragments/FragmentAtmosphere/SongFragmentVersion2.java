...
public class SongFragmentVersion2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Initialise the view
         */
        v = inflater.inflate(R.layout.atmosphere_fragment_version_2, container, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
         ...
         */
        myRecycle = v.findViewById(R.id.recycle_view_atmosphere_version_2);
